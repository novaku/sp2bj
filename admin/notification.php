                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							 <div class="muted pull-left"><i class="icon-globe"></i> Daftar Notifikasi</div>                               
                            </div>
...
<form action="read.php" method="post">
					<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-info" name="read"><i class="icon-check"></i> Daftar Pilihan Hapus</button>
							
						<div class="pull-right">
							Checkbox Semua! <input type="checkbox"  name="selectAll" id="checkAll" />
								<script>
					...
					<div class="post"  id="del<?php echo $id; ?>">
							...
							<hr>										
										...
										<div class="pull-right">
										<a class="btn btn-link"  href="#<?php echo $id; ?>" data-toggle="modal" ><i class="icon-trash"></i> Hapus Notifikasi </a>
									    </div>								
					...
					?>
					<div class="alert alert-info"><strong><i class="icon-info-sign"></i> Tidak ditemukan Notifikasi</strong></div>
					<?php
					}
					?>
...
<script type="text/javascript">
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("Notifikasi Anda Sukses di Hapus", { header: 'Data Delete' });	
			}
			}); 		
			return false;
		});				
