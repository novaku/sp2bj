                 ...
                 ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> Daftar System User Aktivitas Log</div>
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_log.php" method="post">
						            ...
						            <a data-placement="right" title="Click to Delete check item" data-toggle="modal" href="#delete_log" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"> Hapus</i></a>
