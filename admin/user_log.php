                     ...
                     ?>
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-group"></i> Daftar Uraian Users Log</div>
								<div class="muted pull-right">
								Jumlah Rincian User Log: <span class="badge badge-info"><?php  echo $count; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_user_log.php" method="post">
								    ...
								    <a data-placement="right" title="Click to Delete check item" data-toggle="modal" href="#delete_user_log" id="delete"  class="btn btn-danger" name=""><i class="icon-trash icon-large"> Hapus</i></a>
