     <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
						    ...
						    <li>
                            <a href="area_admin.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Administrator
							<?php if($not_read1 == '0'){
				            }else{ ?>
							...
							<li>
                            <a href="area_validasi.php"><i class="icon-chevron-right"></i><i class="icon-remove-sign"></i> Validasi PL/Lelang
					    ...
					    <li>						
						    ...
						    <li class="">
                            <a href="all_lelang.php"><i class="icon-chevron-right"></i><i class="icon-sitemap"></i> Tampil Data Lelang</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* manage TRIS user sidebar*------->	
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Managemen User
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs2" class="collapse">						
                            <li class="">
                            <a href="client_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Tupoksi Staff</a>
                            </li>
						    <li class="">
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Pengaturan User</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* notification sidebar*------->
					    <li class="">
                         ...
                         <li class="">
                           ...
                           <li>
                           <a href="#myModal" data-toggle="modal" tabindex="1"><i class="icon-chevron-right"></i><i class="icon-search"></i>&nbsp;Detail Lebih Lengkap</a>
                           </li>
                          
                           <li>
                           <a href="#myModal1" data-toggle="modal" tabindex="-1" ><i class="icon-chevron-right"></i><i class="icon-search"></i>&nbsp;Berdasarkan Semuanya</a>
                           </li>
                           </ul>
                        </li>
                  </ul>					
