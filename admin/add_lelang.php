...
mysql_query("insert into data_lelang (id_lelang,kode_kegiatan,kode_bidang,nama_prsh,nama_kegiatan,tgl_undangan,Hps,Terbilang_hps,Hari_bapp,tgl_bapp,Bln_bapp,Tgl_angka_bapp,Nilai_penawaran,Terbilang,uang_muka,Hari_bahep,Tgl_nahep,Bln_bahep,Tgl_angka_bahep,Tgl_und_kla_nego,Hari_kla_nego,Tgl_kla_nego,Hari_bakn,Tgl_bakn,Bln_bakn,Tgl_angka_bakn,Harga_nego,Terbilang_nego,Hari_bahpl,Tgl_bahpl,Bln_bahpl,Tgl_angka_bahpl,Hari_bap_pemenang,Tgl_bap_pemenang,Bln_bap_pemenang,Tgl_angka_bap_pemenang,Masa_pemel,Terbilang_pemel,Hari_kontrak,Tgl_kontrak,Bln_kontrak,Tgl_angka_kontrak,Masa_pelaksanaan,Terbilang_masa_pelaks,Waktu_pelaksanaan,Tgl_baph,Hari_splspmk,tgl_splspmk,bln_splspmk,tgl_angka_splspmk,bank_garansi) values('$id_lelang','$kode_kegiatan','$Kode_bidang','$nama_prsh','$nama_kegiatan','$tgl_undangan','$Hps','$Terbilang_hps','$Hari_bapp','$tgl_bapp','$Bln_bapp','$Tgl_angka_bapp','$Nilai_penawaran','$Terbilang','$uang_muka','$Hari_bahep','$Tgl_nahep','$Bln_bahep','$Tgl_angka_bahep','$Tgl_und_kla_nego','$Hari_kla_nego','$Tgl_kla_nego','$Hari_bakn','$Tgl_bakn','$Bln_bakn','$Tgl_angka_bakn','$Harga_nego','$Terbilang_nego','$Hari_bahpl','$Tgl_bahpl','$Bln_bahpl','$Tgl_angka_bahpl','$Hari_bap_pemenang','$Tgl_bap_pemenang','$Bln_bap_pemenang','$Tgl_angka_bap_pemenang','$Masa_pemel','$Terbilang_pemel','$Hari_kontrak','$Tgl_kontrak','$Bln_kontrak','$Tgl_angka_kontrak','$Masa_pelaksanaan','$Terbilang_masa_pelaks','$Waktu_pelaksanaan','$Tgl_baph','$Hari_splspmk','$tgl_splspmk','$bln_splspmk','$tgl_angka_splspmk','$bank_garansi')")or die(mysql_error());
