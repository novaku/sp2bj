            ...
            <div class="row-fluid">
               ...
               <div class="span9" id="content">
                     <div class="row-fluid">
					  ...
					  <div class="alert alert-success"><i class="icon-info-sign"></i> Silahkan isi secara detail</div>
					
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="icon-user"></i>&nbsp;System user merubah Password</div>							 
                            </div>
								...
								?>		
								 <div class="container-fluid">
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										...
										<div class="control-group">
											<div class="controls">
											<button type="submit" class="btn btn-info"><i class="icon-save"></i> Simpan</button>
											</div>
										</div>
									</form>
