				...
				<div class="empty">
                    <div class="alert alert-success alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                         <i class="icon-info-sign"></i>  <strong>Catatan!:</strong> Seleksi checbox jika kamu mau hapus!</div>
               </div>
                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-user"></i> Staf User Pokja</div>
								<div class="muted pull-right">
								Jumlah Pokja user: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="30"><?php echo $row['thumbnails']; ?></td>
                                                
												<?php include('toolttip_edit_delete.php'); ?>															
												<td width="120">
												<a rel="tooltip"  title="Edit Client" id="e<?php echo $id; ?>" href="edit_client.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Rubah User</i></a>
												</td>
