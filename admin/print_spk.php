...
<?php
		...
		<tr>
			...
			<td class="empty" width="80"><a rel="tooltip"  title="Cetak Spk" id="<?php echo $row[0]; ?>" href="print_detil_spk.php<?php print '?id_lelang='.$row[0]; ?>" class="btn btn-success"><i class="icon-print icon-small"> Cetak</i></a></td>
		</tr>
