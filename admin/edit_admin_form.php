   <div class="row-fluid">
   <a href="admin_user.php" class="btn btn-info" id="add" data-placement="right" title="Click to Add System User" ><i class="icon-plus-sign icon-large"></i> Tambah System user</a>
	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-pencil icon-large"></i> Rubah System User</div>
                            </div>
...
<script>
  ...
  $.jGrowl("System User Successfully Update", { header: 'System User di Rubah' });
</script>
<?php
}
?>